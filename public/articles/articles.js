...
async function renderArticle(id) {
  ...
  articleCard.innerHTML = `
        <div class="card-body">
          ...
          <p class="card-text">Email do autor: ${articleRes.article.kb_author_email}</p>
          <p class="card-text">Likes: ${articleRes.article.kb_liked_count}</p>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" id="like${articleRes.article.kb_id}" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
